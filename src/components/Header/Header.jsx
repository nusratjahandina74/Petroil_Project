        ...
        <div className='bg-[#282828] border-b-5 border-[#FFB800]'>
            <Container >
                <div className='font-primary py-[15px] text-white'>
                    <Flex>
                        <FlexRow className='space-x-[49px]'>
                            <FlexCenter className='space-x-[5px]'>
                            ...
                            <FlexCenter className="relative after:content-[''] after:absolute after:top-[3px] after:left-[-27px] after:w-[2px] after:h-[16px] after:bg-[#5C6A92] space-x-[5px]">
                                <FiPhoneCall size={20} />
                                <p className='text-[12px]'>+896 120 5889 (Toll free)</p>
                            </FlexCenter>
                        </FlexRow>
                        <div>
                            <FlexRow className='space-x-[19px]'>
