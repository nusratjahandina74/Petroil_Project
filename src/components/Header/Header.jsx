        ...
        <div className='bg-[#282828] border-b-5 border-[#FFB800]'>
            <Container >
                <div className='font-primary py-[15px] text-white'>
                    <Flex className='flex md:justify-between items-center'>
                        <Flex className='md:flex space-x-[49px]'>
                            ...
                            <Flex className="flex relative after:content-[''] after:absolute after:top-[3px] after:left-[-27px] after:w-[2px] after:h-[16px] after:bg-[#5C6A92] space-x-[5px] items-center">
                                <FiPhoneCall size={20} />
                                <p className='text-[12px]'>+896 120 5889 (Toll free)</p>
                            </Flex>
                        </Flex>
                        <div>
                            <Flex className='flex space-x-[19px]'>
