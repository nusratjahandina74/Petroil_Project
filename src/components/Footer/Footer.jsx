    ...
    return (
        <>
            <div className='pt-[149px] bg-[#1F1F1F] font-primary text-white'>
                <Container>
                    <Flex className='flex justify-between pb-[149px] items-center'>
                        <div>
                            <img src={footerLogo} alt="#footerLogo" />
                            <Flex className='flex space-x-[5px] mt-[33px]'>
                            ...
                            <Flex className='flex space-x-[5px] my-[15px]'>
                                <FiPhoneCall size={20} />
                                <p className='text-[14px]'>+896 120 5889 (Toll free)</p>
                            </Flex>
                            <Flex className='flex space-x-[5px] mb-[34px]'>
                            ...
                            <Flex className='flex space-x-[12px]'>
                        ...
                        <div className='font-primary text-white'>
                            ...
                            <p className='text-[14px] mb-[15px] hover:text-red-500 duration-150'>Home</p>
                            <p className='text-[14px] mb-[15px] hover:text-red-500 duration-150'>About</p>
                            <p className='text-[14px] mb-[15px] hover:text-red-500 duration-150'>Services</p>
                            <p className='text-[14px] hover:text-red-500 duration-150'>Gallery</p>
                        </div>
                        <div className='font-primary text-white'>
                            <h5 className='font-bold mb-[21px]'>Others</h5>
                            <p className='text-[14px] mb-[15px] hover:text-red-500 duration-150'>Blog</p>
                            <p className='text-[14px] mb-[15px] hover:text-red-500 duration-150'>Contact</p>
                            <p className='text-[14px] mb-[15px] hover:text-red-500 duration-150'>Terms & Conditions</p>
                            <p className='text-[14px] hover:text-red-500 duration-150'>Privacy Policy</p>
                        </div>
                        <div className='font-primary text-white pb-[80px]'>
                            <h5 className='font-bold mb-[21px]'>Certificate</h5>
                            <Flex className='flex space-x-[5px]'>
